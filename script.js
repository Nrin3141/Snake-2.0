...
document.getElementById("scoreBoardTarget").appendChild(scoreboard);
...
function canvasResize() {
  if (window.innerHeight <= window.innerWidth) {
    canvas.height =
      window.innerHeight * 0.9 - ((window.innerHeight * 0.9) % 10);
...
function generateNewApple(which) {
  ...
  if (snakeArray.length && snakeArray.length > 3) {
    for (j = 0; j < snakeArray.length; j++) {
      if (
        applePosY === 0 ||
        (applePosX === savedApplePosX && applePosY === applePosY) ||
        (applePosX === snakeArray[j][0] && applePosY === snakeArray[j][1])
      ) {
        generateNewApple();
      }
    }
...
function paintHead() {
  ...
  ctx.fillRect(
    snakeArray[snakeArray.length - 1][0],
  ...
  switch (snakeArray[snakeArray.length - 1][2]) {
    case "left":
      ctx.fillRect(
        snakeArray[snakeArray.length - 1][0] + 0.3 * scl,
        snakeArray[snakeArray.length - 1][1],
        unit,
        unit
      );
      ctx.fillRect(
        snakeArray[snakeArray.length - 1][0] + 0.3 * scl,
        snakeArray[snakeArray.length - 1][1] + 0.8 * scl,
        unit,
        unit
      );
      ...
      ctx.moveTo(
        snakeArray[snakeArray.length - 1][0],
        snakeArray[snakeArray.length - 1][1] + scl / 2 - unit / 2
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] - scl / 2,
        snakeArray[snakeArray.length - 1][1] + scl / 2 - unit / 2
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] - (2 * scl) / 3,
        snakeArray[snakeArray.length - 1][1] + 1.5 * unit
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] - scl / 2 - 0.1 * unit,
        snakeArray[snakeArray.length - 1][1] + scl / 2 - unit / 2 + 0.2 * unit
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] - (2 * scl) / 3,
        snakeArray[snakeArray.length - 1][1] + 3 * unit
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] - scl / 2,
        snakeArray[snakeArray.length - 1][1] + scl / 2
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0],
        snakeArray[snakeArray.length - 1][1] + scl / 2
    ...
    case "right":
      ...
      ctx.beginPath();
      ctx.moveTo(
        snakeArray[snakeArray.length - 1][0] + scl,
        snakeArray[snakeArray.length - 1][1] + scl / 2 - unit / 2
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + (3 * scl) / 2,
        snakeArray[snakeArray.length - 1][1] + scl / 2 - unit / 2
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] +
      ...
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + (3 * scl) / 2 + 0.1 * unit,
        snakeArray[snakeArray.length - 1][1] + scl / 2 - unit / 2 + 0.2 * unit
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] +
    ...
    case "up":
      ctx.fillRect(
        snakeArray[snakeArray.length - 1][0],
        snakeArray[snakeArray.length - 1][1] + 0.3 * scl,
        scl * 0.2,
        scl * 0.2
      );
      ctx.fillRect(
        snakeArray[snakeArray.length - 1][0] + 0.8 * scl,
        snakeArray[snakeArray.length - 1][1] + 0.3 * scl,
        scl * 0.2,
        scl * 0.2
      );
      ...
      ctx.beginPath();
      ctx.moveTo(
        snakeArray[snakeArray.length - 1][0] + scl / 2 - unit / 2,
        snakeArray[snakeArray.length - 1][1]
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + scl / 2 - unit / 2,
      ...
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + 1.5 * unit,
        snakeArray[snakeArray.length - 1][1] - (2 * scl) / 3
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + scl / 2 - unit / 2 + 0.2 * unit,
        snakeArray[snakeArray.length - 1][1] - scl / 2 - 0.1 * unit
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + 3 * unit,
        snakeArray[snakeArray.length - 1][1] - (2 * scl) / 3
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + scl / 2,
    ...
    case "down":
      ctx.fillRect(
        snakeArray[snakeArray.length - 1][0],
        snakeArray[snakeArray.length - 1][1] + 0.5 * scl,
        scl * 0.2,
        scl * 0.2
      );
      ctx.fillRect(
      ...
      ctx.moveTo(
        snakeArray[snakeArray.length - 1][0] + scl / 2 - unit / 2,
        snakeArray[snakeArray.length - 1][1] + scl
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + scl / 2 - unit / 2,
        snakeArray[snakeArray.length - 1][1] + (3 * scl) / 2
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + 1.5 * unit,
        snakeArray[snakeArray.length - 1][1] +
      ...
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + scl / 2 - unit / 2 + 0.2 * unit,
        snakeArray[snakeArray.length - 1][1] + (3 * scl) / 2 + 0.1 * unit
      );
      ctx.lineTo(
        snakeArray[snakeArray.length - 1][0] + 3 * unit,
        snakeArray[snakeArray.length - 1][1] +
...
function paintCorner() {
  ctx.fillStyle = "rgb(50,150,50)";
  switch (
    snakeArray[i][2] //caseSwitch do decide which direction the triangle for the corner needs to be facing
  ) {
    case "left":
...
function stopGame(gameOver) {
  if (gameState === "stopped") {
    ...
    document.getElementById("resumeButtonContainer").removeChild(ResumeButton);
    if (is_touch_device()) {
    ...
    velX = 0;
    velY = 0;
    document.getElementById("resumeButtonContainer").appendChild(ResumeButton);
...
if (is_touch_device()) {
  ...
  document
    .getElementById("toggleFSContainer")
    .appendChild(toggleFullscreenButton);
